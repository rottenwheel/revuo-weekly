...
date: "2026-07-16T22:20:08-05:00"
issuenumber: 256
title: "Issue 256: April 12 - July 16, 2026"
---
...
{{% event "July 22, 2024 (Wednesday) - 18:00 UTC" %}}
...
{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/671" author="r4v3r23" %}}
ANONERO Continued Development (1 year)
{{% /ccs_item %}}

{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/688" author="jeffro256" %}}
full-time development 2026Q2
{{% /ccs_item %}}

{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/683" author="v1docq47" last=1 %}}
Monero Konferenco 2026 voice-over and working on xmr.ru 
{{% /ccs_item %}}

### CCS Proposals Need Funding

{{% ccs_item link="https://ccs.getmonero.org/proposals/redshade-ccs-fullstack-overhaul.html" author="redsh4de" goal=36 raised=0.72 %}}
CCS Frontend Redesign
{{% /ccs_item %}}

{{% ccs_item link="https://ccs.getmonero.org/proposals/syntheticbird_cuprate_scs_ab_3_months.html" author="SyntheticBird" goal=80 raised=7 %}}
Cuprate Address Book, Reproducible Build and Supply Chain Security (3 months)
{{% /ccs_item %}}

{{% ccs_item link="https://ccs.getmonero.org/proposals/koe-dev-1.html" author="koe" goal=113.7 raised=13.72 %}}
...
{{< price_performance
	market_cap="6,220,214,074"
	street_price="367.92"

	table_date="07/16/26"
	price_usd="330.96,+4.60,-4.06,-1.03"
	price_eur="289.32,+4.68,-2.62,+0.60"
	price_btc="0.005202,+4.97,-0.80,+83.80"
