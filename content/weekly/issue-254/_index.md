...
date: "2026-04-01T09:49:13-05:00"
issuenumber: 254
title: "Issue 254: February 27 - April 1, 2026"
---
...
{{% event "April 4, 2026 (Saturday) - 16:00 UTC" %}}
...
{{% event "April 6, 2026 (Monday) - 18:00 UTC" %}}
Monero Tech Meeting - [#no-wallet-left-behind](irc://irc.libera.chat/#no-wallet-left-behind) IRC channel; Matrix [room](https://matrix.to/#/#no-wallet-left-behind:monero.social).
{{% /event %}}

{{% event "April 7, 2026 (Tuesday) - 18:00 UTC" %}}
Cuprate Workgroup Meeting - [#cuprate](irc://irc.libera.chat/#cuprate) IRC channel; Matrix [room](https://matrix.to/#/#cuprate:monero.social).
{{% /event %}}

{{% event "April 8, 2026 (Wednesday) - 18:00 UTC" %}}
...
{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/651" author="CJ" %}}
Grease Payment Channels -- production implementation and SDK
{{% /ccs_item %}}

{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/650" author="jpk68" %}}
I2P SAMv3 support
{{% /ccs_item %}}

{{% ccs_item link="https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/654" author="vtnerd" last=1 %}}
2026 Q2 Proposal
{{% /ccs_item %}}

### CCS Proposals Need Funding

{{% ccs_item link="https://ccs.getmonero.org/proposals/hinto-6.html" author="hinto-janai" goal=137.13 raised=11.02 %}}
Full-time work (3 months)
{{% /ccs_item %}}

{{% ccs_item link="https://ccs.getmonero.org/proposals/jeffro256-full-time-2026Q1.html" author="jeffro256" goal=111 raised=10.14 %}}
Full-time development 2026Q1
{{% /ccs_item %}}

{{% ccs_item link="https://ccs.getmonero.org/proposals/boog_3_months_cuprate_5.html" author="Boog900" goal=108 raised=2.48 %}}
...
{{< price_performance
	market_cap="6,152,145,886"
	street_price="362.56"

	table_date="04/01/26"
	price_usd="333.20,-2.26,-3.16,+53.38"
	price_eur="287.05,-2.44,-2.24,+42.78"
	price_btc="0.004845,+1.23,-5.55,+87.83"
