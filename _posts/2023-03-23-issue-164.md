...
<div class="newsbyte">
    <h4>Monero is set to reduce the maximum tx_extra space in the next point release (0.18.2.1). It represents a non-consensus change, requiring no hardfork. Tag and binaries forthcoming; you may compile from source if you want to get ahead. Your daemon won't accept or rely newly minted NFTs. Merged pull <a href="https://github.com/monero-project/monero/pull/8733" target="_blank">request</a>.</h4>
</div>
